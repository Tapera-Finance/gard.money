 ...
 */
export default function PrimaryButton({ text, onClick, variant, disabled, positioned, exit, purple, toggle, govern }) {

  return (
    <Button variant={variant} disabled={disabled} positioned={positioned} exit={exit} purple={purple} toggle={toggle} govern={govern} onClick={() => onClick()}>
