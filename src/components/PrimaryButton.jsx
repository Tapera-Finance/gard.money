 ...
 */
export default function PrimaryButton({ text, onClick, variant, disabled, positioned, exit, govern }) {

  return (
    <Button variant={variant} disabled={disabled} positioned={positioned} exit={exit} govern={govern} onClick={() => onClick()}>
