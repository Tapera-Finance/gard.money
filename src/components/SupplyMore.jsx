    ...
    let supplyDetails = mobile ? [
      {
        ...
        val: `$${cAsset == null || cAsset == "" ? ((1.05 * mAlgosToAlgos(cdp.debt)) / (mAlgosToAlgos(cdp.collateral))).toFixed(4) : ((1.05 * mAlgosToAlgos(cdp.debt)) / (mAlgosToAlgos(cdp.collateral) + cAsset)).toFixed(4)}`,
        hasToolTip: true,
      },
      {
