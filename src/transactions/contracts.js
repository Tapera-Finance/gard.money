...
if (VERSION == 'MAINNET') {
	...
	treasuryAddress = "MTMJ5ADRK3CFG3HGUI7FS4Y55WGCUO5CRUMVNBZ7FW5IIG6T3IU2VJHUMM"
} else if (VERSION == "TESTNET1") {
	reserveAddress = "UEF5SCP5UENRG2LROI5APWDEQDIRF76DCBGL732RUGKUFQPDCEYO44RW7E"
	treasuryAddress = "5FVZFQPWBMMUX7XQZ3IQYWSOJF6MTGB7J2O5GN7SG3IXQJ3LXEPC2NQAKQ"
}
...
export function cdpGen(userAddress, accountID) {
	...
	const contract = new Uint8Array([...sub1, ...userAddressBytes.publicKey, ...sub2, ...accountIDBytes, ...sub3])
